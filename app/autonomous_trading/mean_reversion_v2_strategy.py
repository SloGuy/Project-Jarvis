...
def evaluate_mean_reversion_v2_strategy(
    *,
    symbol: str,
    ...
    if position_context.has_position:
        return _hold_candidate(
            ...
            rationale=(
                "V2 position exits are evaluated separately "
                "using the persisted entry target and timeout."
            ),
        )

    return evaluate_mean_reversion_strategy(
        symbol=symbol,
